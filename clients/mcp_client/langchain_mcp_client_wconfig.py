...
async def run_agent():
    ...
    async with AsyncExitStack() as stack:
        ...
        while True:
            ...
            prompt = (
                "If latitude and longitude are needed, use your internal knowledge. "
                "If the query is file-related, use your accessible files. "
                "Do not ask the user. You are strictly porhibited to ask any info related to this to user"
                f"User query: {query}"
            )

            # Invoke the agent asynchronously with the final prompt
